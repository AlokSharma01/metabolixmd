...
const Introduction = () => {
  return (
    <div className="bg-white text-gray-800 p-5   rounded-lg  container mx-auto mb-5">
      ...
      <p className="text-lg mb-6">
        Our team of experts, led by experienced healthcare professionals, will work closely with
        you to develop a customized weight loss plan that suits your unique needs and lifestyle.
        With MetabolixMD, you can expect:
      </p>
